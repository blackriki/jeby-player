...
提交 `5679691` 的 SelfContained 产物已通过本地 Public 管线，使用 .NET 8.0.30。上述三份 .NET / WPF 许可原文已随包存在，并记录长度和 SHA256；`distributionReady` 为 `true`。GitHub CI 已通过，公开下载附件见 [Releases](https://github.com/blackriki/jeby-player/releases)。
